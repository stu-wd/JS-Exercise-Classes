...
class Airplane {
 ...
 class Person {
    ...
    eat(someFood){
      (this.stomach.length < 10) ? this.stomach.push(someFood) : "You're full";
    }
 ...
 class Car {
    ...
    fill(gallons){ 
      this.tank += gallons;
      this.tankCapacity = this.tank * this.milesPerGallon;
    }

    drive(distance) {
      if (distance > this.tankCapacity) {
        this.odometer += this.tankCapacity;
        this.tank = 0;
        return `I ran out of fuel at ${this.odometer} gallons!`
      } else {
